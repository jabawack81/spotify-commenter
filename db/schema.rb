...
ActiveRecord::Schema.define(version: 2018_08_19_093824) do
  ...
  create_table "user_allowed_playlists", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "playlist_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["playlist_id"], name: "index_user_allowed_playlists_on_playlist_id"
    t.index ["user_id"], name: "index_user_allowed_playlists_on_user_id"
  end
